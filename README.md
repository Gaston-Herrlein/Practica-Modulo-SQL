...
6. Referente al punto anterior hay una excepción, el campo _Sinopsis_ de la tabla _Pelicula_. Esta es de tipo **Text** para no limitar el largo
7. Se decide separar el Identificacor en una tabla aparte, entendiendo que se pueden registar o con el DNI/NIE, o con el NIF, o con el Pasaporte (esto con el proposito de ampliar las opciones de identificación). De esta forma ampliamos la posibilidad de traer socios de otrso sitios, con sus respectivos _Idenificadores_ y no solamente por registro directo
